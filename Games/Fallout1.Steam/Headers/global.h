...
// Generated automagically from Fallout1.Steam.zip/data/VAULT13.GAM //

#define GVAR_CHILD_KILLER_SHADY         (0)
#define GVAR_CHILD_KILLER_HUB           (1)
#define GVAR_NUM_RADSCORPIONS           (2)
#define GVAR_CHILD_KILLER_ADYTUM        (3)
#define GVAR_DOGS_KILLED                (4)
#define GVAR_DOG_EMPATHY                (5)
#define GVAR_QUEST_PEOPLE               (6)
#define GVAR_FOLLOWERS_INVADED          (7)
#define GVAR_MAP_ENTRANCE_NUMBER        (8)
#define GVAR_DAYS_TO_VAULT13_DISCOVERY  (9)
#define GVAR_VAULT_WATER                (10)
#define GVAR_VAULT_INVADED              (11)
#define GVAR_SHADY_SANDS_INVADED        (12)
#define GVAR_NECROPOLIS_INVADED         (13)
#define GVAR_HUB_INVADED                (14)
#define GVAR_JUNKTOWN_INVADED           (15)
#define GVAR_BROTHERHOOD_INVADED        (16)
#define GVAR_VATS_BLOWN                 (17)
#define GVAR_MASTER_BLOWN               (18)
#define GVAR_NECROPOLIS_VISITED         (19)
#define GVAR_NECROPOLIS_KNOWN           (20)
#define GVAR_MOTEL_OF_DOOM_VISITED      (21)
#define GVAR_HALL_OF_THE_DEAD_VISITED   (22)
#define GVAR_WATERSHED_VISITED          (23)
#define GVAR_NECROPOLIS_VAULT_VISITED   (24)
#define GVAR_TANDI_X                    (25)
#define GVAR_TANDI_STATUS               (26)
#define GVAR_TANDI_DEAD                 (27)
#define GVAR_RADSCORPIONS_KILLED        (28)
#define GVAR_NECROP_MUTANTS_KILLED      (29)
#define GVAR_NECROP_WATER_CHIP_TAKEN    (30)
#define GVAR_NECROP_WATER_PUMP_FIXED    (31)
#define GVAR_LOAD_MAP_INDEX             (32)
#define GVAR_ANIMALS_KILLED             (33)
#define GVAR_HUMANS_KILLED              (34)
#define GVAR_SUPER_MUTANTS_KILLED       (35)
#define GVAR_HIRED_BY_KILLIAN           (36)
#define GVAR_KILLIAN_DEAD               (37)
#define GVAR_GIZMO_DEAD                 (38)
#define GVAR_HIRED_BY_GIZMO             (39)
#define GVAR_IN_JAIL                    (40)
#define GVAR_BUG_PLANTED                (41)
#define GVAR_GOT_CONFESSION             (42)
#define GVAR_RADSCORPION_SEED           (43)
#define GVAR_DEATHCLAW_SEED             (44)
#define GVAR_BROTHERHOOD_SEED           (45)
#define GVAR_HUB_SEED                   (46)
#define GVAR_PLAYER_LOCATION            (47)
#define GVAR_LOXLEY_X                   (48)
#define GVAR_MAXSON_X                   (49)
#define GVAR_CATHEDRAL                  (50)
#define GVAR_VATS_STATUS                (51)
#define GVAR_CHILDREN_STATUS            (52)
#define GVAR_MASTER_DEAD                (53)
#define GVAR_LIEUTENANTS_DEAD           (54)
#define GVAR_COUNTDOWN_TO_DESTRUCTION   (55)
#define GVAR_BOMB_DISARMED              (56)
#define GVAR_ENTERING_VATS_HOW          (57)
#define GVAR_WATER_SHED_STATUS          (58)
#define GVAR_PLAYER_CAPTURED            (59)
#define GVAR_SIGNAL_REWARD              (60)
#define GVAR_SHADOW_PASSWORD            (61)
#define GVAR_FOLLOWER_STEALTH_HELP      (62)
#define GVAR_FOLLOWER_MACHO_HELP        (63)
#define GVAR_KNIGHT_WARNING             (64)
#define GVAR_WORLD_TERRAIN              (65)
#define GVAR_NECROP_WATER               (66)
...
#define GVAR_BROTHERHOOD_12             (80)
#define GVAR_BROTHERHOOD_34             (81)
#define GVAR_BROTHERHOOD_ENTRANCE       (82)
#define GVAR_CAVES                      (83)
#define GVAR_CHILDREN_1                 (84)
#define GVAR_DESERT_1                   (85)
#define GVAR_DESERT_2                   (86)
#define GVAR_DESERT_3                   (87)
#define GVAR_HALL_OF_THE_DEAD           (88)
#define GVAR_HOTEL_OF_DOOM              (89)
#define GVAR_JUNKTOWN_CASINO            (90)
#define GVAR_JUNKTOWN_ENTRANCE          (91)
#define GVAR_JUNKTOWN_KILLIAN           (92)
#define GVAR_SHADY_SANDS_EAST           (93)
#define GVAR_SHADY_SANDS_WEST           (94)
#define GVAR_VAULT_13_MAP               (95)
#define GVAR_BURIED_VAULT_MAP           (96)
#define GVAR_VAULT_ENTRANCE             (97)
#define GVAR_NECROP_VAULT               (98)
#define GVAR_WATERSHED                  (99)
...
#define GVAR_KILL_KILLIAN               (105)
#define GVAR_MISSING_CARAVAN            (106)
...
#define GVAR_GARL_DEAD                  (114)
#define GVAR_TOTAL_RAIDERS              (115)
#define GVAR_MISTAKEN_ID                (116)
#define GVAR_WITH_CARAVAN               (117)
#define GVAR_IAN_STATUS                 (118)
#define GVAR_TOLYA_STATUS               (119)
#define GVAR_PETROX_STATUS              (120)
#define GVAR_HERNANDEZ_STATUS           (121)
#define GVAR_KENJI_STATUS               (122)
#define GVAR_HUNTER_STATUS              (123)
#define GVAR_SETH_STATUS                (124)
#define GVAR_TRENT_STATUS               (125)
#define GVAR_JASON_STATUS               (126)
#define GVAR_ROMEO_JULIET               (127)
#define GVAR_GANG_WAR                   (128)
#define GVAR_DESTROY_FOLLOWERS          (129)
#define GVAR_LOST_BROTHER               (130)
#define GVAR_BLADES_HELP                (131)
#define GVAR_TRAIN_FOLLOWERS            (132)
#define GVAR_FIND_AGENT                 (133)
#define GVAR_TANGLER_DEAD               (134)
#define GVAR_BECOME_BLADE               (135)
#define GVAR_BLADES_LEFT                (136)
#define GVAR_RIPPERS_LEFT               (137)
#define GVAR_FIX_FARM                   (138)
#define GVAR_START_POWER                (139)
#define GVAR_WEAPONS_ARMED              (140)
#define GVAR_FOUND_DISK                 (141)
#define GVAR_WEAPON_LOCKER              (142)
#define GVAR_SAVE_SINTHIA               (143)
#define GVAR_SAUL_QUEST                 (144)
#define GVAR_TRISH_QUEST                (145)
#define GVAR_VATS_ALERT                 (146)
...
#define GVAR_ARTIFACT_DISK              (161)
#define GVAR_FEV_DISK                   (162)
#define GVAR_SECURITY_DISK              (163)
#define GVAR_ALPHA_DISK                 (164)
#define GVAR_DELTA_DISK                 (165)
#define GVAR_VREE_DISK                  (166)
#define GVAR_HONOR_DISK                 (167)
#define GVAR_RENT_TIME                  (168)
#define GVAR_SAUL_STATUS                (169)
#define GVAR_GIZMO_STATUS               (170)
...
#define GVAR_ALOCHOL_ADDICT             (194)
...
#define GVAR_SHERRY_TURNS               (556)
#define GVAR_TRISH_STATUS               (557)
