...
// Generated automagically from MegaMod.zip/data/AI.TXT //
...
#define AI_COCKROACH_SMALL             (187)
#define AI_COCKROACH_LARGE             (188)
#define AI_GILA_MONSTER                (189)
#define AI_PARTY_MERIS_BERSERK         (190)
#define AI_PARTY_MERIS_AGRESSIVE       (191)
#define AI_PARTY_MERIS_DEFENSIVE       (192)
#define AI_PARTY_KLINT_BERSERK         (193)
#define AI_PARTY_KLINT_AGGRESSIVE      (194)
#define AI_PARTY_KLINT_DEFENSIVE       (195)
#define AI_PARTY_KLINT_COWARD          (196)
#define AI_PARTY_KLINT_CUSTOM          (197)
#define AI_PARTY_DIAGO_CUSTOM          (198)
#define AI_PARTY_DIAGO_DEFENSIVE       (199)
#define AI_BOS_WARRIORS                (200)
#define AI_PUGALO                      (201)
#define AI_PARTY_MERIS_COWARD          (202)
#define AI_PARTY_MERIS_CUSTOM          (203)
#define AI_PARTY_DIAGO_AGGRESSIVE      (204)
#define AI_PARTY_DIAGO_BERSERK         (205)
#define AI_PARTY_DIAGO_COWARD          (206)
#define AI_PARTY_KITSUNE_BERSERK       (207)
#define AI_PARTY_KITSUNE_AGGRESSIVE    (208)
#define AI_PARTY_KITSUNE_DEFENSIVE     (209)
#define AI_PARTY_KITSUNE_COWARD        (210)
#define AI_PARTY_KITSUNE_CUSTOM        (211)
#define AI_PARTY_CATJULES_BERSERK      (212)
#define AI_PARTY_CATJULES_AGGRESSIVE   (213)
#define AI_PARTY_CATJULES_DEFENSIVE    (214)
#define AI_PARTY_CATJULES_COWARD       (215)
#define AI_PARTY_CATJULES_CUSTOM       (216)
#define AI_PARTY_DEX_BERSERK           (217)
#define AI_PARTY_DEX_AGGRESSIVE        (218)
#define AI_PARTY_DEX_DEFENSIVE         (219)
#define AI_PARTY_DEX_COWARD            (220)
#define AI_PARTY_DEX_CUSTOM            (221)
