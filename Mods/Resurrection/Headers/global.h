...
// Generated automagically from Resurrection.zip/data/VAULT13.GAM //
...
#define GVAR_TOWN_REP_NEWHOPE                      (47)
#define GVAR_TOWN_REP_SEDIT                        (48)
#define GVAR_TOWN_REP_RATHOLE                      (49)
#define GVAR_TOWN_REP_CORATH                       (50)
#define GVAR_TOWN_REP_ALBUQUERQUE                  (51)
#define GVAR_TOWN_REP_MUTANT_CAMP                  (52)
#define GVAR_TOWN_REP_EMPORER_CITY                 (53)
...
#define GVAR_QUEST_NH_TOMMY                        (696)
#define GVAR_QUEST_NH_FIND_NECKLACE                (697)
#define GVAR_NH_TOMMY_FOUND                        (698)
#define GVAR_NH_CAVE_CRITTERS                      (699)
#define GVAR_ENEMY_NEWHOPE                         (700)
#define GVAR_NH_OSWALD_DMG                         (701)
#define GVAR_QUEST_NH_LETTER                       (702)
#define GVAR_QUEST_NH_BRAHMIN                      (703)
#define GVAR_QUEST_NH_GECKON                       (704)
#define GVAR_NH_PAST_BRAHMIN                       (705)
#define GVAR_NH_LOV_HUNTERS                        (706)
#define GVAR_QUEST_S_NHCARAVANS                    (707)
#define GVAR_NH_OVERPRODUCTION                     (708)
#define GVAR_QUEST_NH_SECRET_NECKLACE              (709)
#define GVAR_HELEN_DEATH                           (710)
#define GVAR_QUEST_S_RODRIGUES_RAIDERS             (711)
#define GVAR_QUEST_S_RODRIGUES_GHOULS              (712)
#define GVAR_SEX_WITH_WOMAN                        (713)
#define GVAR_SEX_WITH_MAN                          (714)
#define GVAR_SEX_WITH_BRAHMIN                      (715)
#define GVAR_QUEST_S_MALCOLM_POLICEMAN             (716)
#define GVAR_QUEST_S_MALCOLM_GORDON                (717)
#define GVAR_QUEST_S_TYLER_POISON                  (718)
#define GVAR_QUEST_S_TYLER_NICOL                   (719)
#define GVAR_QUEST_S_TYLER_SHERIFF                 (720)
#define GVAR_FALCON_POLICEMEN_OFF                  (721)
#define GVAR_SEDIT_TYLER_IS_SHERIFF                (722)
#define GVAR_QUEST_S_DAVID_KIDNAP_INVESTIGATION    (723)
#define GVAR_QUEST_A_DAVID_KIDNAP_COMPLICITY       (724)
#define GVAR_QUEST_S_NICOL_NECKLACE                (725)
#define GVAR_LUCY_SEX                              (726)
#define GVAR_LUCY_KISS                             (727)
#define GVAR_LUCY_SPEECH                           (728)
#define GVAR_LUCY_DESTROY                          (729)
#define GVAR_DAVID_SPEECH                          (730)
#define GVAR_DAVID_DESTROY                         (731)
#define GVAR_QUEST_S_KEVIN_MEETING                 (732)
#define GVAR_QUEST_S_RODRIGUES_TYLER               (733)
#define GVAR_KNOW_ABOUT_FREDERYKS_DEAD             (734)
#define GVAR_SEDIT_CARAVANS_LEAVE                  (735)
#define GVAR_QUEST_S_NICOL_MARVIN                  (736)
#define GVAR_QUEST_S_NICOL_BRAHMINS                (737)
#define GVAR_QUEST_S_NICOL_CRATER                  (738)
#define GVAR_QUEST_S_MARVIN_TUNNEL                 (739)
#define GVAR_QUEST_S_CHARLIE_JUNK                  (740)
#define GVAR_QUEST_JOHNATAN_CAVE                   (741)
#define GVAR_FREDERYKS_DREAM_LEAVE                 (742)
#define GVAR_QUEST_S_FREDERYK_MEETING              (743)
#define GVAR_QUEST_S_FREDERYK_INFORMANT            (744)
#define GVAR_QUEST_S_FREDERYK_NOTICE               (745)
#define GVAR_QUEST_S_FREDERYK_RAIDERS              (746)
#define GVAR_DEAL_WITH_RAIDERS                     (747)
#define GVAR_QUEST_S_FREDERYK_CARAVANA             (748)
#define GVAR_DUDE_NICOL_MEETING                    (749)
#define GVAR_SFROST_DRINK_PROGRESS                 (750)
#define GVAR_FROST_DESTROY                         (751)
#define GVAR_JEREMY_DRINK_PROGRESS                 (752)
#define GVAR_JEREMY_DESTROY                        (753)
#define GVAR_JEREMY_DEAL                           (754)
#define GVAR_NICOLS_Q1450                          (755)
#define GVAR_TIM_DRINK_PROGRESS                    (756)
#define GVAR_TIM_DESTROY                           (757)
#define GVAR_QUEST_S_RAIDERS_CARAVANA              (758)
#define GVAR_PETER_SPEECH                          (759)
#define GVAR_TYLER_SPEECH                          (760)
#define GVAR_FREDERYK_SPEECH                       (761)
#define GVAR_NICOL_SPEECH                          (762)
#define GVAR_DEMETRE_SPEECH                        (763)
#define GVAR_STAPLETON_SPEECH                      (764)
#define GVAR_RENE_SPEECH                           (765)
#define GVAR_BRUCE_SPEECH                          (766)
#define GVAR_CHUVA_DESTROY                         (767)
#define GVAR_S_TUNNEL_DEATHCLAWS                   (768)
#define GVAR_ENEMY_SEDIT                           (769)
#define GVAR_ENEMY_RODRIGUES                       (770)
#define GVAR_TADEUS_DESTROY                        (771)
#define GVAR_TIM_BRIBE                             (772)
#define GVAR_JEREMY_BRIBE                          (773)
#define GVAR_ENEMY_LOST_QUARTER                    (774)
#define GVAR_ENEMY_KIDNAPPERS_IN_SEDIT             (775)
#define GVAR_SEDIT_GHOULS_KILLER                   (776)
#define GVAR_SEDIT_POLICEMAN_SPEECH                (777)
#define GVAR_AIDS_STADIUM_1                        (778)
#define GVAR_AIDS_STADIUM_2                        (779)
#define GVAR_AIDS_STADIUM_3                        (780)
#define GVAR_KEVIN_DESTROY                         (781)
#define GVAR_MARVIN_DESTROY                        (782)
#define GVAR_CRIMSON_CARAVAN_LEAVE                 (783)
#define GVAR_QUEST_S_PETERS_FEED                   (784)
#define GVAR_QUEST_S_TADEUS_MURDER                 (785)
#define GVAR_QUEST_S_PETERS_MANTISTS               (786)
#define GVAR_DEMETRE_FEV                           (787)
#define GVAR_QUEST_S_MIMI_FOOD                     (788)
#define GVAR_QUEST_S_MIMI_GOLD                     (789)
#define GVAR_QUEST_S_MIMI_RODRIGUES                (790)
#define GVAR_QUEST_S_MIMI_CARAVAN                  (791)
#define GVAR_SEDIT_DEAD_GANGSTERS                  (792)
#define GVAR_SEDIT_DEAD_GHOULS                     (793)
#define GVAR_QUEST_S_RODRIGUES_DRUNK               (794)
#define GVAR_S_MARVIN_LIE                          (795)
#define GVAR_S_FREDERYK_MEETING_TIME               (796)
#define GVAR_RH_JULIAN_DEAD                        (797)
#define GVAR_RH_ALEXA_DEAD                         (798)
#define GVAR_RH_Q_JULIAN_QUEST1                    (799)
#define GVAR_RH_Q_JULIAN_QUEST2                    (800)
#define GVAR_RH_Q_JULIAN_QUEST3                    (801)
#define GVAR_RH_Q_ALEXA_QUEST1                     (802)
#define GVAR_RH_Q_ALEXA_QUEST2                     (803)
#define GVAR_RH_Q_ALEXA_QUEST3                     (804)
#define GVAR_RH_Q_QUEST_MARIE                      (805)
#define GVAR_RH_Q_TREVR_CIGARETS                   (806)
#define GVAR_RH_Q_LETTER_QUEST2                    (807)
#define GVAR_RH_FarleyAboutReed                    (808)
#define GVAR_RH_GeorgeAboutLetter                  (809)
#define GVAR_RH_ReadReedNotes                      (810)
#define GVAR_RH_ReadExamNotes                      (811)
#define GVAR_RH_AlexaMayKilledMarie                (812)
#define GVAR_RH_ALEXA_TOLDKILLER                   (813)
#define GVAR_RH_ALEXA_SUICIDE                      (814)
#define GVAR_RH_NORTH_KNOWN                        (815)
#define GVAR_RH_JULIAN_WANT_LEONARD                (816)
#define GVAR_RH_TruthAboutFuneral                  (817)
#define GVAR_RH_LEONARD_SEARCH                     (818)
#define GVAR_RH_ENEMY_JULIAN                       (819)
#define GVAR_RH_ENEMY_LEONARD                      (820)
#define GVAR_RH_KILLS_MAN                          (821)
#define GVAR_RH_KILLS_WOMAN                        (822)
#define GVAR_RH_KILLS_OTHER                        (823)
#define GVAR_ENEMY_CORATH                          (824)
#define GVAR_C_QUEST_MURDERS                       (825)
#define GVAR_C_QUEST_SISTERS_TO_BROTHEL            (826)
#define GVAR_C_QUEST_CHADWIC_WANT_SUZAN            (827)
#define GVAR_C_QUEST_SAVE_ABBY                     (828)
#define GVAR_C_QUEST_FIND_GRAVEDIGGER              (829)
#define GVAR_C_QUEST_UNCLE_Q1                      (830)
#define GVAR_C_QUEST_UNCLE_Q2                      (831)
#define GVAR_C_QUEST_UNCLE_Q3                      (832)
#define GVAR_C_QUEST_UNCLE_Q4                      (833)
#define GVAR_C_QUEST_NESTOR_Q1                     (834)
#define GVAR_C_QUEST_NESTOR_Q2                     (835)
#define GVAR_C_QUEST_NESTOR_Q3                     (836)
#define GVAR_C_QUEST_NESTOR_Q4                     (837)
#define GVAR_C_QUEST_HELP_GRAVEDIGGER              (838)
#define GVAR_C_QUEST_LINSDAY_OPERATION             (839)
#define GVAR_C_CHADWIC_IS_MURDERER                 (840)
#define GVAR_C_STRIKE_IN_MINE                      (841)
#define GVAR_C_CORATH_STATUS                       (842)
#define GVAR_C_RING_VICTORIES                      (843)
#define GVAR_PERK_GIVINE_FAVOR_TAKEN_LEVEL         (844)
#define GVAR_DRUNK_TIME                            (845)
#define GVAR_PERK                                  (846)
#define GVAR_SDOKTOR_ABOUT_AIDS                    (847)
#define GVAR_NESTOR_LEAVED_CORATH                  (848)
#define GVAR_C_RING_POINTER                        (849)
#define GVAR_C_ENEMY_NESTOR                        (850)
#define GVAR_C_ENEMY_UNCLE                         (851)
#define GVAR_C_ENEMY_MINERS                        (852)
#define GVAR_C_ENEMY_OBYVAT                        (853)
#define GVAR_KILL_COUNT                            (854)
#define GVAR_C_UNCLES_KILLS                        (855)
#define GVAR_ONEILL_SPEECH                         (856)
#define GVAR_FRIENDLY_FIRE                         (857)
#define GVAR_KILLING_SPREE_POINTS                  (858)
#define GVAR_AQ_MUTANT_HUNTER                      (859)
#define GVAR_AQ_ENEMY_PRISTEH                      (860)
#define GVAR_AQ_ENEMY_VEX                          (861)
#define GVAR_AQ_ENEMY_PRIMITIVES                   (862)
#define GVAR_AQ_ENEMY_HOSPITAL                     (863)
#define GVAR_AQ_ENEMY_HUNTERS                      (864)
#define GVAR_AQ_ALBUQ_EVENTS                       (865)
#define GVAR_AQ_ALBUQ_SPEECHES                     (866)
#define GVAR_AQ_ALBUQ_DEATHS                       (867)
#define GVAR_AQ_SOPHI_CATR_DIALOG                  (868)
#define GVAR_AQ_QUEST_SOPHIE_MUTATION              (869)
#define GVAR_AQ_QUEST_BRING_VEX_HEAD               (870)
#define GVAR_AQ_QUEST_KILL_WILLIAM_WIFE            (871)
#define GVAR_AQ_QUEST_CHUCK_SWEETHEARTS            (872)
#define GVAR_AQ_QUEST_BEN_ALEEYA                   (873)
#define GVAR_AQ_QUEST_FIND_FELIX_VELAZQUEZ         (874)
#define GVAR_AQ_QUEST_TRIBE_SOLVE_LOSTS            (875)
#define GVAR_AQ_QUEST_TRIBE_HELP_REVEGE            (876)
#define GVAR_AQ_QUEST_HOSPITAL_HUNTINGS            (877)
#define GVAR_AQ_QUEST_HOSPITAL_TO_KILL_PRIMITIVES  (878)
#define GVAR_AQ_QUEST_MTHUNT_SEBASTIAN_QUEST       (879)
#define GVAR_AQ_QUEST_MTHUNT_10TALISMAN_QUEST      (880)
#define GVAR_AQ_QUEST_MTHUNT_TULSA_QUEST           (881)
#define GVAR_AQ_QUEST_MTHUNT_HERMAN_QUEST          (882)
#define GVAR_AQ_QUEST_MTHUNT_DUTCH_QUEST           (883)
#define GVAR_AQ_PENNY_MEETINGS_NUMBERS             (884)
#define GVAR_AQ_PENNY_SHOWING_TIME                 (885)
#define GVAR_AQ_FRIEND_OF_THE_TRIBE                (886)
#define GVAR_AQ_QUEST_HOSPITAL_NEED_INFORMATION    (887)
#define GVAR_AQ_QUEST_TRIBE_HUNTINGS               (888)
#define GVAR_AQ_HUNTINGS_RESULTS                   (889)
#define GVAR_AQ_PRIMITIVES_COUNTER                 (890)
#define GVAR_AQ_DOCTORS_COUNTER                    (891)
#define GVAR_AQ_PRIMITIVES_HUNTING_COUNTER         (892)
#define GVAR_AQ_PRIMATACKERS_COUNTER               (893)
#define GVAR_AQ_DAMIAN_ABOUT_VEX                   (894)
#define GVAR_AQ_DAVID_KIDNAP_IN_SHITS              (895)
#define GVAR_AQ_MARIO_BOROWED_TO_CHUCK             (896)
#define GVAR_AQ_QUEST_HOSPITAL_HERMAN              (897)
#define GVAR_AQ_MUTANT_HUNTERS_CANDIDATE           (898)
#define GVAR_AQ_HOSPITAL_GIVERS_STATUS             (899)
#define GVAR_AQ_HOSPITAL_ATTACKERS_STATUS          (900)
#define GVAR_AQ_QUEST_MTHUNT_VISIT_DOCTOR          (901)
#define GVAR_AQE_QUEST_NEGOTIATION_WITH_MTHUNT     (902)
#define GVAR_AQE_QUEST_GET_OUR_VAULT_BACK          (903)
#define GVAR_AQE_ALBUQ_EMPEROR_EVENTS              (904)
#define GVAR_AQ_SLINTA_WAITING_TIME                (905)
#define GVAR_MC_MUTANT_CAMP_EVENTS                 (906)
#define GVAR_MC_QUEST_BRING_SEBASTIAN              (907)
#define GVAR_MC_SPEAKED_WITH_THOMAS                (908)
#define GVAR_MH_MUTANT_HUNTERS_ATACK_STATUS        (909)
#define GVAR_PTR_PARTY_MEMBER_ACTIONS              (910)
#define GVAR_KARAVAN_ROUTES_COMMAND_BITS           (911)
#define GVAR_KARAVAN_FREDERYK_ELIMINATED           (912)
#define GVAR_KARAVAN_SEDIT_ELIMINATED              (913)
#define GVAR_KARAVAN_CRIMSON_ELIMINATED            (914)
#define GVAR_KARAVAN_GUARDS_COUNTER                (915)
#define GVAR_KARAVAN_ATACKERS_COUNTER              (916)
#define GVAR_NESTORS_CONTRACT_KILLERS_ON           (917)
#define GVAR_OBRODA_FIRST_ECC_MEET_DONE            (918)
#define GVAR_PROGEMA_STATUS                        (919)
#define GVAR_EC_HITMAN_FLOAT                       (920)
#define GVAR_EC_WANDERER                           (921)
#define GVAR_AQ_PAUL_IS_ANGRY                      (922)
#define GVAR_PROGEMA_DUDE_IS_ROBOT                 (923)
#define GVAR_PROGEMA_THROUGHT_THE_HOLE             (924)
#define GVAR_PROGEMA_DUDE_ESCAPED                  (925)
#define GVAR_EC_CAVEDIV_MSG                        (926)
#define GVAR_ENEMY_OBRODA                          (927)
#define GVAR_G_MARIO_PRISONED                      (928)
#define GVAR_G_ELEVATOR                            (929)
#define GVAR_G_HUNTERS_COUNTER                     (930)
#define GVAR_G_LEONARD_KNOWN                       (931)
#define GVAR_G_TRAMELL_KNOWN                       (932)
#define GVAR_G_DARRELL_KNOWN                       (933)
#define GVAR_G_JESS_KNOWN                          (934)
#define GVAR_G_ERICK_KNOWN                         (935)
#define GVAR_G_MAX_REGISTRATION                    (936)
#define GVAR_G_MAX_EQUIP                           (937)
#define GVAR_G_PERSONAL_ROBO                       (938)
#define GVAR_G_LAST_USED_NAME                      (939)
#define GVAR_G_FEARGUS_KNOWN                       (940)
#define GVAR_G_CHRIS_KNOWN                         (941)
#define GVAR_G_CECILIA_HANDY                       (942)
#define GVAR_G_GAUSS_RIFLE                         (943)
#define GVAR_G_CECILIA_KNOWN                       (944)
#define GVAR_G_JAMES_KNOWN                         (945)
#define GVAR_G_ROBERT_KNOWN                        (946)
#define GVAR_G_ELEV35_ACCESS                       (947)
#define GVAR_G_ELEV35_VIOLENT                      (948)
#define GVAR_G_RICHARD_KILLED_NORMALS              (949)
#define GVAR_G_ROBO_PARTS_KNOWN                    (950)
#define GVAR_G_QUEST_FREE_PRISONERS_FIGHT          (951)
#define GVAR_G_QUEST_FREE_PRISONERS_SNEAK          (952)
#define GVAR_G_BASE_DESTROYED                      (953)
#define GVAR_G_BASE_TIME_OF_DESTRUCTION            (954)
#define GVAR_G_GEOFF_KNOWN                         (955)
#define GVAR_G_BLUE6_PRISONERS_KNOWN               (956)
#define GVAR_G_PROGEMA_HOLOGRAM                    (957)
#define GVAR_G_PARTY_LEFT_COUNTER                  (958)
#define GVAR_G_DUDE_ENTER_TO_SPAS                  (959)
#define GVAR_G_RICHARD_KNOWN                       (960)
#define GVAR_G_TALKED_WITH_SPASITEL                (961)
#define GVAR_G_ENERGY_FIELDS                       (962)
#define GVAR_G_SEC_ROBOTS_ACTIVATION               (963)
#define GVAR_G_HUNTERS_FLOATS                      (964)
#define GVAR_RH_GEORGE_DEAD                        (965)
#define GVAR_AQ_VAULT_16_STATUS                    (966)
#define GVAR_AQ_EMPEROR_STATUS                     (967)
#define GVAR_AQ_MHUNTERS_STAY                      (968)
#define GVAR_S_PATER_DEAD                          (969)
#define GVAR_END_SEDIT_LOST                        (970)
#define GVAR_END_SEDIT_FREDERYK                    (971)
#define GVAR_END_SEDIT_CRIMSON                     (972)
#define GVAR_S_DEMETRE_DEAD                        (973)
#define GVAR_END_KERI                              (974)
#define GVAR_KERI_DEAD                             (975)
#define GVAR_S_TYLER_DEAD                          (976)
#define GVAR_END_SEDIT_TYLER                       (977)
#define GVAR_END_CORATH                            (978)
#define GVAR_END_RATHOLE                           (979)
#define GVAR_END_RATHOLE_GEORGE                    (980)
#define GVAR_END_NEWHOPE                           (981)
#define GVAR_END_PLAYER                            (982)
#define GVAR_END_OBRODA                            (983)
#define GVAR_END_ALBU_CITY                         (984)
#define GVAR_END_ALBU_LYSTRA                       (985)
#define GVAR_END_ALBU_HOSPITAL                     (986)
#define GVAR_END_ALBU_WILLIAM                      (987)
#define GVAR_END_MUTANTS                           (988)
#define GVAR_END_GABRIEL                           (989)
#define GVAR_AQE_QUEST_ELISA_1                     (990)
#define GVAR_AQE_QUEST_ELISA_2                     (991)
#define GVAR_AQE_QUEST_ELISA_3                     (992)
#define GVAR_AQE_QUEST_ANONYM_1                    (993)
#define GVAR_AQE_QUEST_ANONYM_2_FIGHT              (994)
#define GVAR_AQE_QUEST_ANONYM_2_SPEECH             (995)
#define GVAR_AQE_QUEST_ANONYM_3                    (996)
#define GVAR_AQE_QUEST_B_SNEED                     (997)
#define GVAR_AQE_ENEMY_EMPEROR                     (998)
#define GVAR_AQE_QUEST_COLE                        (999)
#define GVAR_AQE_ALBUQ_EMPEROR_EVENTS_NEXT         (1000)
#define GVAR_AQE_BRAD_WAITING_TIME                 (1001)
#define GVAR_AQE_COLE_WAITING_TIME                 (1002)
#define GVAR_AQE_MARIO_WAITING_TIME                (1003)
#define GVAR_AQE_FIND_LYSTRAS_BROTHER              (1004)
#define GVAR_AQE_KILL_ALL_ALIENS_ON_FLOOR          (1005)
#define GVAR_AQE_MESAGE_FROM_ELISA                 (1006)
#define GVAR_AQE_MESAGE_FROM_ARAN                  (1007)
#define GVAR_AQE_HELP_TO_ARAN                      (1008)
#define GVAR_AQE_BENICIO_TIME_LIMIT                (1009)
#define GVAR_AQE_EMPEROR_TIME_LIMIT                (1010)
#define GVAR_AQE_EMPEROR_SOLDIERS_COUNT            (1011)
#define GVAR_AQE_2ST_FLOOR_ALIENS_KILLED           (1012)
#define GVAR_AQE_VAULT_SOLDIERS_KILLED             (1013)
#define GVAR_AQE_VAULT_HUNTERS_KILLED              (1014)
#define GVAR_PTR_KERI_REACTIONS                    (1015)
#define GVAR_S_RAIDERS_KILLED                      (1016)
#define GVAR_AQE_DIRECTIONS_SETUP                  (1017)
#define GVAR_PTR_GABRIEL_REACTIONS                 (1018)
#define GVAR_PTR_LYSTRA_REACTIONS_1                (1019)
#define GVAR_PTR_LYSTRA_REACTIONS_2                (1020)
#define GVAR_NESTOR_LEAVED_CORATH_TIME             (1021)
#define GVAR_S_FREDERYKS_BANKRUPT                  (1022)
#define GVAR_CARAVANS_RANDOM_ECCS                  (1023)
#define GVAR_CARAVAN_JEREMY_ESCAPED                (1024)
#define GVAR_PROGEMA_ABOUT_ALIENS                  (1025)
#define GVAR_CARAVAN_RAID_BODYCOUNT                (1026)
#define GVAR_CORATH_DIALOG_BITS_NEXT               (1027)
#define GVAR_C_QUEST_MORTONS_MONEY                 (1028)
#define GVAR_AQE_KICK_BENICIO_FROM_ALBUQUERQUE     (1029)
#define GVAR_MC_SEBASTIAN_NOT_CONVINCED            (1030)
#define GVAR_AQ_PRIMITIVES_HELP_TIMER              (1031)
#define GVAR_HIV_LAST_STAGE_TIME                   (1032)
#define GVAR_HIV_NEXT_STAGE_TIME                   (1033)
#define GVAR_AIDS_ENDURANCE_LOSS                   (1034)
#define GVAR_AIDS_CHARISMA_LOSS                    (1035)
#define GVAR_PERK_LEADER_PARTY                     (1036)
#define GVAR_RH_GeorgeAboutFuneral                 (1037)
#define GVAR_S_TALK_KEVIN_FREDERYK                 (1038)
#define GVAR_SPECIAL_ENCOUNTER_STARGATE            (1039)
#define GVAR_SPECIAL_ENCOUNTER_SPAMMERS            (1040)
#define GVAR_SPECIAL_ENCOUNTER_MACGYVER            (1041)
#define GVAR_DEAD_PARTYMEMBER                      (1042)
#define GVAR_ENC_NUMBERS_GHOULS                    (1043)
#define GVAR_ENC_NUMBERS_CARAVANS                  (1044)
#define GVAR_ENC_NUMBERS_ANIMALS                   (1045)
#define GVAR_ENC_NUMBERS_RAIDERS                   (1046)
#define GVAR_ENC_NUMBERS_HITMEN                    (1047)
#define GVAR_ENC_NUMBERS_WANDERER                  (1048)
#define GVAR_ENC_NUMBERS_REFUGEES                  (1049)
#define GVAR_ENC_NUMBERS_JUNKIES                   (1050)
#define GVAR_ENC_NUMBERS_MHUNTERS                  (1051)
#define GVAR_ENC_NUMBERS_TRIBALS                   (1052)
#define GVAR_NH_DEATH_HELEN                        (1053)
#define GVAR_NH_DEATH_COUNTER                      (1054)
#define GVAR_END_ARAN_DEAD                         (1055)
#define GVAR_END_ELISA_DEAD                        (1056)
#define GVAR_PROGEMA2_CRUSH                        (1057)
#define GVAR_FRED_SPEC_KARAVAN_LOST                (1058)
#define GVAR_DAY_OF_VEX_AFTER                      (1059)
#define GVAR_SEDIT_CAVE_KNOW                       (1060)
#define GVAR_WILD_PARADISE_DESTROYED               (1061)
#define GVAR_MACGYVER_SPEECH                       (1062)
